...
class PlanExecutor:
    ...
    async def execute(self, commands: list, ws, goal: str = "", final_goal: str | None = None, resume_task: bool = False, preserve_task: bool = False, source: str | None = None, reason: str = "", _goal_retry: bool = False, task_id: str | None = None) -> None:
        self._run_id += 1
        ...
        if resume_task:
            ...
            task_memory.save(goal, commands, final_goal=final_goal, source=source, reason=reason, task_id=task_id)
